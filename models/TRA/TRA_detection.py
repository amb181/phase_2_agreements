...
agreement_type = "TRA"
model_path = "/home/rasa-stakeholder-assistant/Desktop/" + agreement_type + "_model/"
new_data_path = "/home/rasa-stakeholder-assistant/Desktop/" + agreement_type + "_model/" + agreement_type + "/"
...
def Train_Model():
    ...
    if os.path.isfile(file1) and os.path.isfile(file2) and os.path.isfile(file3) and os.path.isfile(file4):
        ...
        df.groupby(['Section']).size().reset_index(name='counts')
